    ...
    <div class="row">
        <div class="col-sm-offset-1 col-sm-11">
            <form action="update_bio.php" method="post">
             ...
             <div class="form-group">
                    ...
                    <div class="input-group" >
                        ...
                        <span class="input-group-addon success"><span class="glyphic glyphicon-ok"></span></span>
                    </div>
                </div>
         ...
         <div class="form-group">
                    ...
                    <div class="input-group" >
                     <input type="text" class="form-control" name="id" id="id" placeholder="id" style="display:none"></input>
...
<?php
    ...
    echo '<div id="tag_cat1" class="col-md-3">Category1';
    ...
    echo '</div>';
    /* CATEGORY 2 */
   echo '<div id="tag_cat2" class="col-md-3">Category2';
    global $string2;
    $string2= $row['cat2'];
    ...
    echo '</div>';
    /* CATEGORY 3 */
   echo '<div id="tag_cat3" class="col-md-3">Category3';
    global $string3;
    $string3= $row['cat3'];
    ...
    echo '</div>';
    /* CATEGORY 4 */
   echo '<div id="tag_cat4" class="col-md-3">Category4';
    global $string4;
    $string4= $row['cat4'];
...
if (isset($_GET['id']))
{
    ...
    require("include/connect.php");
    $result=mysql_query("SELECT * FROM data_base where id=".$_GET['id'],$connection);
    if (!$result)
    echo("<script>alert('database query failed:".mysql_error()."';</script>");
    while ($row=mysql_fetch_array($result))
    {
        $str11="hello";
        $string1 = str_replace("\"", '\"', $row["bio"]); // Replaces all spaces with hyphens.
        $string2 = str_replace("\"", '\"', $row['summary']); // Replaces all spaces with hyphens.
    echo 'document.getElementById("username").value="'.$row["name"].'";document.getElementById("email").value="'.$row["email"].'";document.getElementById("max_requests").value="'.$row["max_requests"].'";document.getElementById("bio").value="'.$string1.'";document.getElementById("summary").value="'.$string2.'";document.getElementById("id").value="'.$_GET["id"].'";';
    }
    echo "});</script>";
}
